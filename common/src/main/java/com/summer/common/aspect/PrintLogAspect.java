package com.summer.common.aspect;//package com.ljm.chat.pointcut;
...
public class PrintLogAspect {
    ...
    @Pointcut("@annotation(com.summer.common.annotation.PrintLog)")
    ...
    @AfterThrowing(pointcut = "printLogPointcut()", throwing = "e")
