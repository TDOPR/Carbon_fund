package com.summer.controller.monitor.server;


import com.summer.common.util.ArithUtil;
...
public class Jvm {
    ...
    public String getStartTime() {
        return DateUtil.formatDate(DateUtil.getServerStartDate(), DateUtil.SIMPLE_DATETIME_FORMAT);
    }
